  ...
  <div class="feeds-inner">
    ...
    <div class="drag">
      ...
      <div
        ...
        v-bind:class="{ 'selected':  inputArg.status === 'unread' }"
        id="unread"
      ...
      <div
        ...
        v-bind:class="{ 'selected':  inputArg.status === 'read' }"
        id="read"
        class="sidebar-category-top"
      >
        <span class="glyphicon">
      ...
      <div
        ...
        v-bind:class="{ 'selected':  inputArg.status === 'star' }"
        id="star"
        class="sidebar-category-top"
      >
        <span class="glyphicon">
      ...
      <div
        v-on:click="loadAll()"
        v-bind:class="{ 'selected':  inputCategory === null }"
        id="all"
        class="sidebar-category-top"
      >
        <span class="glyphicon">
        ...
        <span class="badge-unread">
          <span v-if="inputArg.status === 'unread'" class="badge white">{{ unreadCount }}</span>
          <span v-if="inputArg.status === 'read'" class="badge white">{{ readCount }}</span>
          <span v-if="inputArg.status === 'star'" class="badge white">{{ starCount }}</span>
        </span>
      </div>
      <div>
      ...
      >
        ...
        >
          <div class="sidebar-category-sub">
            ...
            <span class="badge-unread">
              <span
                v-if="inputArg.status === 'unread'"
                class="badge white"
              >{{ category.unreadCount }}</span>
              <span
                v-if="inputArg.status === 'read'"
                class="badge white"
              >{{ category.readCount }}</span>
              <span
                v-if="inputArg.status === 'star'"
                class="badge white"
...
export default {
  props: ["inputCategory", "inputFeed", "inputArg"],
  data() {
    return {
      categoriesOrder: [],
      refreshing: false,
